...
bool member::has_role(uint64_t role_id) {
...
const std::string& member::get_username() const
{
  return usr->get_username();
}

const std::string& member::get_discriminator() const
{
  return usr->get_discriminator();
}

const std::string& member::get_fullname() const
{
